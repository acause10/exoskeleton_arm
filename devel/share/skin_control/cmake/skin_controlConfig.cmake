...
if("TRUE" STREQUAL "TRUE")
  set(skin_control_SOURCE_PREFIX /home/hsa/exo_ws/src/skin_control)
  set(skin_control_DEVEL_PREFIX /home/hsa/exo_ws/devel)
  ...
  set(skin_control_INSTALL_PREFIX /home/hsa/exo_ws/install)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'skin_control' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/hsa/exo_ws/src/skin_control/${idir}'.  ${_report}")
    endif()
...
foreach(depend ${depends})
  ...
  list(APPEND skin_control_EXPORTED_TARGETS ${${skin_control_dep}_EXPORTED_TARGETS})
endforeach()
