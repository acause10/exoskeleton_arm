#ifndef _ROS_tum_ics_ur_robot_msgs_ForceQPData_h
#define _ROS_tum_ics_ur_robot_msgs_ForceQPData_h
...
namespace tum_ics_ur_robot_msgs
{
  ...
  class ForceQPData : public ros::Msg
  {
    ...
    virtual const char * getType() override { return "tum_ics_ur_robot_msgs/ForceQPData"; };
