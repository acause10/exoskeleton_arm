#ifndef _ROS_SERVICE_setControllerCmd_h
#define _ROS_SERVICE_setControllerCmd_h
#include <stdint.h>
#include <string.h>
#include <stdlib.h>
#include "ros/msg.h"
...
static const char SETCONTROLLERCMD[] = "tum_ics_ur_robot_msgs/setControllerCmd";

  class setControllerCmdRequest : public ros::Msg
  {
    public:
      typedef const char* _cmd_type;
      _cmd_type cmd;

    setControllerCmdRequest():
      cmd("")
    {
    }
    ...
    virtual const char * getType() override { return SETCONTROLLERCMD; };
    virtual const char * getMD5() override { return "43a54fa49066cddcf148717d9d4a6353"; };

  };

  class setControllerCmdResponse : public ros::Msg
  {
    public:
      typedef bool _ok_type;
      _ok_type ok;

    setControllerCmdResponse():
      ok(0)
    {
    }
  ...
  class setControllerCmd {
    public:
    typedef setControllerCmdRequest Request;
    typedef setControllerCmdResponse Response;
  };
