#ifndef _ROS_SERVICE_enableSkinCellValuesPub_h
#define _ROS_SERVICE_enableSkinCellValuesPub_h
#include <stdint.h>
#include <string.h>
#include <stdlib.h>
#include "ros/msg.h"
...
static const char ENABLESKINCELLVALUESPUB[] = "tum_ics_skin_modular_msgs/enableSkinCellValuesPub";

  class enableSkinCellValuesPubRequest : public ros::Msg
  {
    public:
    ...
    enableSkinCellValuesPubRequest():
      topicName(""),
      enable(0)
    {
    }
    ...
    virtual const char * getType() override { return ENABLESKINCELLVALUESPUB; };
    virtual const char * getMD5() override { return "67fd202f5483585e8c48ee512a52e9aa"; };

  };

  class enableSkinCellValuesPubResponse : public ros::Msg
  {
    public:
      typedef bool _ok_type;
      _ok_type ok;

    enableSkinCellValuesPubResponse():
      ok(0)
    {
    }
  ...
  class enableSkinCellValuesPub {
    public:
    typedef enableSkinCellValuesPubRequest Request;
    typedef enableSkinCellValuesPubResponse Response;
  };
