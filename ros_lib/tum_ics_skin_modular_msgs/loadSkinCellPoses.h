#ifndef _ROS_SERVICE_loadSkinCellPoses_h
#define _ROS_SERVICE_loadSkinCellPoses_h
#include <stdint.h>
#include <string.h>
#include <stdlib.h>
#include "ros/msg.h"
...
static const char LOADSKINCELLPOSES[] = "tum_ics_skin_modular_msgs/loadSkinCellPoses";

  class loadSkinCellPosesRequest : public ros::Msg
  {
    public:
    ...
    virtual const char * getType() override { return LOADSKINCELLPOSES; };
    virtual const char * getMD5() override { return "33b509be697fb1a069fccba656762bcc"; };

  };

  class loadSkinCellPosesResponse : public ros::Msg
  {
    public:
      typedef bool _ok_type;
      _ok_type ok;

    loadSkinCellPosesResponse():
      ok(0)
    {
    }
  ...
  class loadSkinCellPoses {
    public:
    typedef loadSkinCellPosesRequest Request;
    typedef loadSkinCellPosesResponse Response;
  };
