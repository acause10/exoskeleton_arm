#ifndef _ROS_SERVICE_enableSkinCellDataPub_h
#define _ROS_SERVICE_enableSkinCellDataPub_h
#include <stdint.h>
#include <string.h>
#include <stdlib.h>
#include "ros/msg.h"
...
static const char ENABLESKINCELLDATAPUB[] = "tum_ics_skin_msgs/enableSkinCellDataPub";

  class enableSkinCellDataPubRequest : public ros::Msg
  {
    public:
    ...
    virtual const char * getType() override { return ENABLESKINCELLDATAPUB; };
    virtual const char * getMD5() override { return "67fd202f5483585e8c48ee512a52e9aa"; };

  };

  class enableSkinCellDataPubResponse : public ros::Msg
  {
    public:
      typedef bool _ok_type;
      _ok_type ok;

    enableSkinCellDataPubResponse():
      ok(0)
    {
    }
  ...
  class enableSkinCellDataPub {
    public:
    typedef enableSkinCellDataPubRequest Request;
    typedef enableSkinCellDataPubResponse Response;
  };
