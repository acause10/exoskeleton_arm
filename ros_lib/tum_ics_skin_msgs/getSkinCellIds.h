#ifndef _ROS_SERVICE_getSkinCellIds_h
#define _ROS_SERVICE_getSkinCellIds_h
#include <stdint.h>
#include <string.h>
#include <stdlib.h>
#include "ros/msg.h"
...
static const char GETSKINCELLIDS[] = "tum_ics_skin_msgs/getSkinCellIds";

  class getSkinCellIdsRequest : public ros::Msg
  {
    public:

    getSkinCellIdsRequest()
    {
    }
    ...
    virtual const char * getType() override { return GETSKINCELLIDS; };
    virtual const char * getMD5() override { return "d41d8cd98f00b204e9800998ecf8427e"; };

  };

  class getSkinCellIdsResponse : public ros::Msg
  {
    public:
    ...
    virtual const char * getType() override { return GETSKINCELLIDS; };
    virtual const char * getMD5() override { return "20fc846dce6c87a6a9471a78ab296772"; };

  };

  class getSkinCellIds {
    public:
    typedef getSkinCellIdsRequest Request;
    typedef getSkinCellIdsResponse Response;
  };
