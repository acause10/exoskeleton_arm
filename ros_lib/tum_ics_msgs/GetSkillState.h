#ifndef _ROS_SERVICE_GetSkillState_h
#define _ROS_SERVICE_GetSkillState_h
#include <stdint.h>
#include <string.h>
#include <stdlib.h>
#include "ros/msg.h"
...
static const char GETSKILLSTATE[] = "tum_ics_msgs/GetSkillState";

  class GetSkillStateRequest : public ros::Msg
  {
    public:
      typedef const char* _skill_id_type;
      _skill_id_type skill_id;

    GetSkillStateRequest():
      skill_id("")
    {
    }
    ...
    virtual const char * getType() override { return GETSKILLSTATE; };
    virtual const char * getMD5() override { return "d578921e927c6e6a448131a8e442257c"; };

  };

  class GetSkillStateResponse : public ros::Msg
  {
    public:
  ...
  class GetSkillState {
    public:
    typedef GetSkillStateRequest Request;
    typedef GetSkillStateResponse Response;
  };
